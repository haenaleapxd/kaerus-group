...
export default function Image({
  ...
  const { image, multiImageSelection } = useSelect(
    (select) => {
      ...
      return {
        ...
        multiImageSelection: multiSelectedClientIds.length && multiSelectedClientIds.every(
  ...
  const {
    canInsertCover, imageEditing, imageSizes, maxWidth, mediaUpload,
  } = useSelect(
    (select) => {
      const {
